...
function generateUboSyncPolyfillSTD40(uboElements) {
    return generateUboSyncPolyfill(uboElements, uboSyncFunctions.uboSingleFunctionsSTD40, (uboElement) => {
...
function generateUboSyncPolyfillWGSL(uboElements) {
    return generateUboSyncPolyfill(uboElements, uboSyncFunctions.uboSingleFunctionsWGSL, (uboElement) => {
