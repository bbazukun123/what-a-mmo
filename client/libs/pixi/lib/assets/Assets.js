...
Extensions.extensions
    .handleByList(Extensions.ExtensionType.LoadParser, Assets.loader.parsers)
    .handleByList(Extensions.ExtensionType.ResolveParser, Assets.resolver.parsers)
    .handleByList(Extensions.ExtensionType.CacheParser, Assets.cache.parsers)
    .handleByList(Extensions.ExtensionType.DetectionParser, Assets.detections);
...
Extensions.extensions.handle(
    Extensions.ExtensionType.Asset,
    (extension) => {
    ...
    (extension) => {
        ...
        Object.keys(assetKeyMap)
            .filter((key) => !!ref[key])
            .forEach((key) => Extensions.extensions.remove(ref[key]));
    },
);
