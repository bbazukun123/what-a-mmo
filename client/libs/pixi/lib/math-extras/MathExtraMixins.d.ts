...
declare global {
    namespace PixiMixins {
        ...
        interface Rectangle {
            ...
            ): import('../maths/shapes/Rectangle').Rectangle;
            intersection<T extends import('../maths/shapes/Rectangle').Rectangle>(
                other: import('../maths/shapes/Rectangle').Rectangle,
                outRect: T,
            ): T;

            union(other: import('../maths/shapes/Rectangle').Rectangle): import('../maths/shapes/Rectangle').Rectangle;
            union<T extends import('../maths/shapes/Rectangle').Rectangle>(
                other: import('../maths/shapes/Rectangle').Rectangle,
                outRect: T,
            ): T;
        }
    ...
    interface Vector2Math {
        ...
        add<T extends import('../maths/point/PointData').PointData>(
        ...
        subtract<T extends import('../maths/point/PointData').PointData>(
            other: import('../maths/point/PointData').PointData,
            outPoint: T,
        ): T;

        multiply(other: import('../maths/point/PointData').PointData): import('../maths/point/Point').Point;
        multiply<T extends import('../maths/point/PointData').PointData>(
            other: import('../maths/point/PointData').PointData,
            outPoint: T,
        ): T;
        ...
        project<T extends import('../maths/point/PointData').PointData>(
        ...
        reflect<T extends import('../maths/point/PointData').PointData>(
