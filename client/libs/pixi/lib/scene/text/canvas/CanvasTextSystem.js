...
class CanvasTextSystem {
     ...
     */
    renderTextToCanvas(text, style, padding, resolution, canvasAndContext) {
        ...
        for (let i = 0; i < passesCount; ++i) {
            ...
            if (isShadowPass) {
                ...
                context.shadowColor = Color.Color.shared
                ...
                context.fillStyle = style._fill
                    ? getCanvasFillStyle.getCanvasFillStyle(style._fill, context, measured)
                    : null;
                if (style._stroke?.width) {
