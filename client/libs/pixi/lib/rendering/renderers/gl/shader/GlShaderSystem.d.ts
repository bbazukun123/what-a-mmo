...
export declare const WEBGL_TO_WEBGPU_UNIFORM_MAP: {
    float: string;
    int: string;
    vec2: string;
    vec3: string;
...
export declare class GlShaderSystem implements ShaderSystem {
    ...
    ensureUniformStructures(shader: Shader): void;
    bloop(uniformGroup: UniformGroup, glProgram: GlProgram): void;
    /**
