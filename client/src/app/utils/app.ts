import { Assets, Container, RenderTexture, Sprite, Texture, Ticker } from 'pixi.js';
 ...
 */
export async function loadAndReplaceTextureWithSpinner(sprite: Sprite, asset: string) {
