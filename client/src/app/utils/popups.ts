...
export async function showGearSlotInfo(def?: Gear) {
  return showScreen("gearSlot", {
    data: { def } as GearSlotPopupComponentProps,
    force: true,
  });
}

export async function showEquipmentLootPopup(
  data: EquipmentLootPopupComponentProps,
) {
...
export async function showSkillInfo(id: SkillId, isActionable = false) {
  return showScreen("skillInfo", {
    data: { id, isActionable } as SkillInfoPopupComponentProps,
    force: true,
  });
}

export async function showSkillUpgradeCongratulations(
  props: SkillUpgradeCongratulationsPopupComponentProps,
) {
  return showScreen("skillUpgradeCongratulations", {
    data: props,
    force: true,
  });
}
...
export async function showPalInfo(id: PalId, isActionable = false) {
  return showScreen("palInfo", {
    data: { id, isActionable } as PalInfoPopupComponentProps,
    force: true,
  });
}

export async function showPalUpgradeCongratulations(
  props: PalUpgradeCongratulationsPopupComponentProps,
) {
...
export async function showGachaConfirmDraw({
  type,
  id,
}: GachaPriceOptions): Promise<boolean> {
...
export async function showGachaCongratulations(
  props: GachaCongratulationsComponentProps,
) {
...
export async function showRetentionDialoguePopup(
  props: RetentionDialogue,
): Promise<void> {
  return new Promise<void>((resolve) => {
