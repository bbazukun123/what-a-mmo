...
export namespace SetClass {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: SetClass): void {
    SetClass.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): SetClass {
    return SetClass.getTypeScriptAlgebraicType().deserialize(reader);
  }
